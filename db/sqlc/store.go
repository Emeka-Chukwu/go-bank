...
type Store interface {
	Querier
	TransferTx(ctx context.Context, arg TransferTxParams) (TransaferTxResult, error)
}
...
func (store *SQLStore) TransferTx(ctx context.Context, arg TransferTxParams) (TransaferTxResult, error) {
